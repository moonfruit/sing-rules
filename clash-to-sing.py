            ...
            "rule_set": [
                {
                    ...
                    "tag": "AI",
                    "format": "binary",
                    "url": "https://cdn.jsdelivr.net/gh/moonfruit/sing-rules/rules/ai.srs",
                ...
                },
                {
                    ...
                    "tag": "Disney+",
                    "format": "binary",
                    "url": "https://cdn.jsdelivr.net/gh/moonfruit/sing-rules/rules/disney-plus.srs",
                    "download_detour": "DIRECT",
                },
                {
                    "type": "remote",
                    "tag": "Netflix",
                    "format": "binary",
                    "url": "https://cdn.jsdelivr.net/gh/moonfruit/sing-rules/rules/netflix.srs",
                    "download_detour": "DIRECT",
                },
                {
                    "type": "remote",
                    "tag": "Youtube",
                    "format": "binary",
                    "url": "https://cdn.jsdelivr.net/gh/moonfruit/sing-rules/rules/youtube.srs",
                    "download_detour": "DIRECT",
                },
                {
                    "type": "remote",
                    "tag": "Block",
                    "format": "binary",
                    "url": "https://cdn.jsdelivr.net/gh/moonfruit/sing-rules/rules/block.srs",
                    "download_detour": "DIRECT",
                },
                {
                    "type": "remote",
                    "tag": "Direct",
                    "format": "binary",
                    "url": "https://cdn.jsdelivr.net/gh/moonfruit/sing-rules/rules/direct.srs",
                    "download_detour": "DIRECT",
                },
                {
                    "type": "remote",
                    "tag": "Private",
                    "format": "binary",
                    "url": "https://cdn.jsdelivr.net/gh/moonfruit/sing-rules/rules/private.srs",
                    "download_detour": "DIRECT",
                },
                {
                    "type": "remote",
                    "tag": "Proxy",
                    "format": "binary",
                    "url": "https://cdn.jsdelivr.net/gh/moonfruit/sing-rules/rules/proxy.srs",
                    "download_detour": "DIRECT",
                },
            ],
            "final": "🐟 漏网之鱼",
